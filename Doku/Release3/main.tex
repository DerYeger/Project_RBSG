    	...
    	\subsection{Ge\"anderte User Stories vom Sprint \RN{5}}
   		...
   		\subsection{User Stories}
   			...
   			\subsubsection{Ingame - Einheit ausw"ahlen - Angriffsphase}
   				...
   				\paragraph{Ergebnis}
		   			Die Ziel wurde umgesetzt. G\"ultigte Angriffsziele wurden rot und ung\"ultige grau markiert.
    	...
    	\subsection{\"Ubernommene Tasks aus Sprint \RN{5}}
   		...
   		\subsection{Tasks}
			...
			\subsubsection{Spectating - REST Anfrage}
				...
				\paragraph{Ergebnis}
					Der Client sendete nun eine der Serverdokumentation entsprechende REST-Anfrage, auch wenn diese nicht ben\"otigt wurde.
			...
			\subsubsection{Ingame - Nicht ausw"ahlbar - Angriffsphase}
				...
				\paragraph{Ergebnis}
					Nach Absprache mit dem PO wurde das Ziel leicht ge\"andert. Einheiten waren weiterhin ausw\"ahlbar, jedoch wurden alle Angriffsziele ung\"ultig.
		\subsection{Bugs}
