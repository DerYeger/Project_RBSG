	...
	\section{Sprint \RN{5}}
	    ...
	    \subsection{User Stories} \label{User_Stories_5}
	        ...
	        \subsubsection{Ingame - Phase beenden}
	            ...
	            \paragraph{Ziel}
	                Es sollte einen Button geben, welcher bei Bet\"atigung die aktuelle Phase beendete. Dies sollte nur m\"oglich sein, wenn der Nutzer auch seine Phase beenden konnte.
	            \paragraph{Story}
            ...
            \subsubsection{Ingame - Einheit angreifen}
	            ...
	            \paragraph{Story}
	                Karli ist in der Angriffsphase und hat bereits eine Einheit ausgew\"ahlt. Karli sieht alle Felder in Rot, die angegriffen werden k\"onnen. Karli w\"ahlt eine gegnerische Einheit auf diesen Feldern aus und greift sie an. Die eigene Einheit ist nicht mehr auswählbar und ist nicht mehr ausgewählt.
            ...
            \subsubsection{Ingame - Game Over}
	            ...
	            \paragraph{Story}
	                Karli hat keine Einheiten mehr und verliert das Spiel. Karli sieht, wie sich Karlis Playercard schwarz f"arbt (Name und Icon). Karli kann ausw"ahlen, ob in die Lobby gewechselt oder ob dem Spiel als Spectator beigetreten wird.
            \subsubsection{Ingame - Game Won}
	            ...
	            \paragraph{Story}
	                Karli hat als einziger noch Einheiten und gewinnt das Spiel. Karli wechselt in die Lobby.
            ...
            \subsubsection{Ingame - Spectator Over}
	            ...
	            \paragraph{Story}
	                Karli sieht, dass Bob als einziger noch Einheiten hat und das Spiel endet. Karli wechselt in die Lobby.
            \subsubsection{Ingame - Einheiteninformationen}
	            \paragraph{Zuteilung}
	                Diese User Story wurde auf 8 Storypoints gesch\"atzt und an Georg Siebert zugeteilt.
	            \paragraph{Ziel}
	                Bewegte der Nuzter die Maus \"uber eine Einheit, sollten alle verf\"ugbaren Informationen dieser Einheit in der Sidebar angezeigt werden.
	            \paragraph{Story}
	                Karli befindet sich bereits in einem Spiel. Karli fährt mit seinem Mouse-Courser über eine Einheit. Es werden Karli alle wichtigen Informationen über die Einheit in der Sidebar angezeigt (siehe MockUps).
        ...
        \subsection{User Stories im Backlog}
        	...
        	\subsubsection{Optional - Lobby - Anzeigen der Einheiten einer Armee}
	        	\paragraph{Zuteilung}
	        		Diese User Story wurde bereits im Release \RN{2} auf 5 Storypoints gesch"atzt und war in diesem Sprint niemandem zugeteilt.
	        	\paragraph{Ziel}
	        		Der Entwickler sollte ein Overlay implementieren, dass die Einheiten einer nicht ausgew"ahlten Armee anzeigte, wenn man "uber das Icon hoverte.
	        	\paragraph{Story}
		    ...
		    \subsubsection{Optional - Ingame - Auf gegnerischen Aktionen scrollen}
			    \paragraph{Ziel}
			    	Der Entwickler sollte ein automatisches Springen auf der Karte implementieren, wenn ein Gegner eine Aktion durchf"uhrt.
			    \paragraph{Story}
			...
			\subsubsection{Optional - Waiting Room - Minigame}
				\paragraph{Ziel}
					Der Entwickler sollte ein Minispiel implementieren.
				\paragraph{Story}
