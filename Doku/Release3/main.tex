    ...
    \newpage
		...
		\subsection{Domain Stories}
			...
			Der Nutzer klickt auf g\"ultiges Zielfeld und best\"atigt die Aktion (siehe Abbildung \ref{Domain_Story_Move_2}).
		    	...
		    	\end{figure}
			Die Anwendung sendet eine Nachricht, welche die Bewegung beschreibt, an den Server. Dieser informiert die Anwendung \"uber, dass die Aktion zul\"assig ist. Die Anwendung aktualisiert das Datenmodell und das Benutzerinterface wird aktualisiert (siehe Abbildung \ref{Domain_Story_Move_3}).
		    	\begin{figure}[H] 
		    		\centering
