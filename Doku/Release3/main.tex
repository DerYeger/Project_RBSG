...
\begin{document}
	...
	\section{Sprint \RN{5}}
	    ...
	    \subsection{User Stories} \label{User_Stories_5}
            ...
            \subsubsection{Ingame - Einheit ausw\"ahlen}
	            ...
	            \paragraph{Ziel}
	                Durch Anklicken einer Einheit soll diese Ausgewählt werden. Danach soll die Bewegungs- und Angriffsreichweite sichtbar sein, je nachdem in welcher Phase der Nutzer sich befindet.
	            \paragraph{Story}
    ...
    \newpage
        ...
        \subsection{Analyse}
        	...
        	\subsubsection{Angefangene Stories}
        		Wie bereits w\"ahrend der Analyse des Burndown erw\"ahnt, wurden drei Stories zum Ende des Sprints noch nicht ganz abgeschlossen. Im kommenden Abschnitt wird es einen kleinen \"Uberblick geben, wie weit jene fortgeschritten sind.
        	...
        	\subsubsection{Nicht abgeschlossene Stories/Tasks}
        		Des Weiteren wurden neben den drei bereits neu angefangenen Stories noch weitere zw\"olf Stories beziehungsweise Tasks aufgrund von Zeitgr"unden nicht angefangen und abgeschlossen (siehe Abbildung \ref{To_Do_5}). Diese Aufgaben waren nicht optional und sollten von unserem Team im n\"achsten Sprint bew\"altigt werden.
        		\begin{figure}[H] 
        			\centering
        	...
        	\subsubsection{Entfernte Tasks}
        		Am Ende des f\"unften Sprints wurden der Task \glqq Einheiteninformationen im Datenmodell\grqq\ aus dem Sprint in das Backlog verschoben, um das Ziel f\"uer den n\"achsten Sprint somit leichter einhalten zu k\"onnen.
        	\subsubsection{Fazit}
        		Zwar wurde das Ziel von 116 Storypoints in diesem Sprint eindeutig nicht bew\"altigt und das Ergebnis mit 29 abgeschlossen Storypoints wirkt nicht zufriedenstellend, jedoch arbeitete das Team \"uber 80 Stunden daran m\"oglichst viele der Features umzusetzen. Um die Mindestanforderungen zu erf\"ullen sollte sich das Team im n\"achsten Sprint darauf konzentrieren die Entwicklungsgeschwindigkeit zu steigern. Die Qualit\"atssicherung (siehe Abbildung \ref{Coverage_5}) hingegen betrug zum Ende des f\"unften Sprints bereits 79\%.
        		\begin{figure}[H] 
        			\centering
    ...
    \section{Sprint \RN{6}}
    	...
    	\subsection{Sprintziel}
    		...
    		\end{itemize}
    		Wenn genug Zeit bleibt, sollte noch eine Box in der Sidebar implementiert werden, die es erm\"oglicht Aktionen, wie Bewegen oder Angreifen, zu best\"atigen und abzubrechen. Weitere optionale Features liegen bereits im Backlog vor (siehe Kapitel \ref{Backlog_6}). Falls das Team die Umsetzung der oben genannten Features schafft sind die Mindestanforderungen jedoch bereits erf\"ullt.
    	\subsection{Ge\"anderte User Stories vom Sprint \RN{5}}
    		...
    		\subsubsection{Ingame - Minikarte anzeigen}
    			...
    			\paragraph{Ge"andertes Ziel}
    				Der Entwickler soll eine Minikarte implementieren. Auf der Minikarte soll es m"oglich sein, den Sichtbereich zu wechseln.
