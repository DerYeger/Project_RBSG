    ...
    \newpage
		...
		\subsection{Domain Stories}
		    ...
		    \subsubsection{Ready}
			    ...
			    \begin{figure}[H] 
			    	\centering
			    	\includegraphics[width=0.8\textwidth]{images/domain_stories/readyStory1.png}
			    	\caption{Domain Story: Ready 1}
			    	\label{Domain_Story_Ready_1}
			    \end{figure}
			    \begin{figure}[H] 
			    	\centering
			    	\includegraphics[width=0.8\textwidth]{images/domain_stories/readyStory2.png}
			    	\caption{Domain Story: Ready 2}
			    	\label{Domain_Story_Ready_2}
			    \end{figure}
		    	\begin{figure}[H] 
		    		\centering
		    		\includegraphics[width=0.8\textwidth]{images/domain_stories/readyStory3.png}
		    ...
		    \subsubsection{Move}
		    	...
		    	\begin{figure}[H] 
		    		\centering
		    		\includegraphics[width=0.8\textwidth]{images/domain_stories/moveStory1.png}
		    		\caption{Domain Story: Move 1}
		    		\label{Domain_Story_Move_1}
		    	\end{figure}
		    	\begin{figure}[H] 
		    		\centering
		    		\includegraphics[width=0.8\textwidth]{images/domain_stories/moveStory2.png}
		    		\caption{Domain Story: Move 2}
		    		\label{Domain_Story_Move_2}
		    	\end{figure}
		    	\begin{figure}[H] 
		    		\centering
		    		\includegraphics[width=0.8\textwidth]{images/domain_stories/moveStory3.png}
     ...
     \newpage	
    	\subsection{Zeit\"ubersicht}
    		...
    		\begin{longtable}[H]{p{6cm} c c c c }
    			...
    			Ingame - Bestätigungsbox in der Sidebar & ? h & - & - & Georg Siebert \\
    			\midrule
