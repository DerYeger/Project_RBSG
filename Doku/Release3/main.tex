    	...
    	\subsection{\"Ubernommene Tasks aus Sprint \RN{5}}
   		...
   		\subsection{Tasks}
   			...
   			\subsubsection{Ingame - Best\"atigungsbox in der Sidebar}
   				\paragraph{Zuteilung}
   					Diese Task wurde auf 3 Zeitstunden gesch"atzt und dan Georg Siebert zugeteilt.
				\paragraph{Ziel}
			...
			\subsubsection{Spectating - REST Anfrage}
				\paragraph{Zuteilung}
					Diese Task wurde auf 1 Zeitstunde gesch"atzt und dan Juri Lozowoj zugeteilt.
				\paragraph{Ziel}
