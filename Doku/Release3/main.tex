	...
	\section{Sprint \RN{5}}
	    ...
	    \subsection{User Stories} \label{User_Stories_5}
            ...
            \subsubsection{Ingame - Einheit ausw\"ahlen}
	            ...
	            \paragraph{Ziel}
	                Durch Anklicken einer Einheit soll diese Ausgewählt werden. Danach soll die Bewegungs- und Angriffsreichweite sichtbar sein, je nachdem in welcher Phase der User sich befindet.
	            \paragraph{Story}
            ...
            \subsubsection{Ingame - Spectator Over}
	            \paragraph{Zuteilung}
	                Diese User Story wurde auf 2 Storypoints gesch\"atzt und an Tobias Klipp zugeteilt.
	            \paragraph{Ziel}
	                Wenn das Spiel vorbei ist soll ein Overlay angezeigt werden. Auf dem Overlay kann der User in die Lobby oder den Login wechseln.
	            \paragraph{Story}
        ...
        \subsection{User Stories im Backlog}
        	...
        	\subsubsection{Optional - Lobby - Anzeigen der Einheiten einer Armee}
	        	...
	        	\paragraph{Story}
	        		Albert befindet sich im ArmyBuilder. Es sind Armeen vorhanden. Albert hovert �ber eine Armee. Es erscheint ein Overlay, in welchem die Einheiten der Armeen sehen kann.
		    ...
		    \subsubsection{Optional - Ingame - Auf gegnerischen Aktionen scrollen}
			    ...
			    \paragraph{Story}
			    	Karli ist nicht an der Reihe und schaut den Gegnern zu. Immer wenn ein Gegner eine Aktion durchf�hrt (Bewegen bzw. Angreifen einer Einheit), sieht Karli, wie sich der Bildschirm auf die Aktion zentriert.
    ...
    \newpage
        ...
        \subsection{Analyse}
        	...
        	\subsubsection{Angefangene Stories}
        		Wie bereits w�hrend der Analyse des Burndown erw�hnt, wurden drei Stories zum Ende des Sprints noch nicht ganz abgeschlossen. Im kommenden Abschnitt wird es einen kleinen �berblick geben, wie weit jene fortgeschritten sind.
