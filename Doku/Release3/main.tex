...
\begin{document}
	...
	\section{Sprint \RN{5}}
	    ...
	    \subsection{User Stories} \label{User_Stories_5}
	        Die User Stories, die vom Product Owner erstellt wurden, sind wie gefolgt aufgebaut: Dem Titel kann entnommen werden, zu welcher Szene die Story geh"orte. Anschlie"send werden die Story Points und der zugeteilte Entwickler genannt. Danach folgt die Story und das Ziel. Das Ziel fasst die Subtasks, die der Scrum Master erstellt hat, zusammen. Danach werden alle Subtasks aufgelistet. Falls die Story abgeschlossen wurde, wird der Verlauf und das Ergebnis dokumentiert. Falls die Story nur angefangen wurde, wird der Verlauf und der Stand dokumentiert.
            ...
            \subsubsection{Ingame - Einheit ausw\"ahlen} \label{story_select_unit}
	            ...
	            \paragraph{Ziel und Subtasks}
	           		...
	           		\end{enumerate}
           		\paragraph{Verlauf}
           			Es wurden circa zw"olf Stunden an dieser Story gearbeitet, sodass noch circa eine Stunde zu der gesch"atzten Zeit "ubrig blieb. Die Funktion war bereits gegeben, jedoch wollte der Entwickler im n"achsten Sprint noch nach einem Fehler suchen, bei dem das UI nicht richtig markiert wurde.
           		\paragraph{Stand}
            ...
            \subsubsection{Ingame - Minikarte anzeigen} \label{story_minimap}
	            ...
	            \paragraph{Ziel und Subtasks}
	            	...
	            	\end{enumerate}
            	\paragraph{Verlauf}
            		Obwohl die Story noch nicht abgeschlossen wurde, wurde die Zeitsch"atzung diesen Sprint bereits "uberschritten. Es wurden schon 25 Minuten mehr gearbeitet. Die Funktionalit"at war allerdings bereits gegeben. Die Story wurde nur noch nicht beendet, da sich ihre zweite Subtask am Ende des Sprints, genauso wie die MockUps \"anderten (Weitere Informationen folgen dazu im Kapitel \ref{changed_user_story_minimap}).
            	\paragraph{Stand}
    ...
    \section{Sprint \RN{6}}
    	...
    	\subsection{Ge\"anderte User Stories vom Sprint \RN{5}}
   		...
   		\subsection{User Stories}
   			...
   			\subsubsection{Ingame - Einheit bewegen nach Bewegung}
  				...
  				\paragraph{Story}
   				...
   				\paragraph{Ziel und Subtasks}
   					Nachdem der Nutzer eine Einheit bewegte, sollte diese erneut ausgew\"ahlt sein, falls sie noch verbleibende Bewegungspunkte besa"s.
   					\begin{enumerate}[label={}]
   					...
   					\end{enumerate}
   				\paragraph{Verlauf}
   					In dieser Story wurde die Zeitsch"atzung fast genau eingehalten. Der Entwickler brauchte nur 13 Minuten l"anger.
   				\paragraph{Ergebnis}
   		...
   		\subsection{Ge\"anderte Tasks vom Sprint \RN{5}}
   			...
   			\subsubsection{Einheiteninformationen im Datenmodell}
   				...
   				\paragraph{Verlauf}
   					Die Umsetzung dieses Tasks verlief deutlich schneller als erwartet. Der Entwickler ben\"otigte nur 1 Stunde und 28 Minuten.
   				\paragraph{Ergebnis}
   					Die Einheiteninformationen liegen nur noch in einer Enumeration vor. Erneute \"Anderungen der Einheiten-IDs f\"uhren nicht mehr zu fehlerhaften Darstellungen und bei \"Anderungen ihrer Namen werden diese als Fallback verwendet.
    	\subsection{\"Ubernommene Tasks aus Sprint \RN{5}}
			...
			\subsubsection{Servernachrichten}
				...
				\paragraph{Ergebnis}
					Alle Servernachrichten zum Aktualisieren des Datenmodells werden korrekt verarbeitet.
   		\subsection{Tasks}
   			...
   			\subsubsection{Waiting Room - Armeeauswahlbox anpassen}
				...
				\paragraph{Verlauf}
					Der Entwickler ben\"otigte lediglich 30 Minuten, wodurch die erwartete Entwicklungsdauer um 1 Stunde und 30 Minuten unterschritten wurde.
				\paragraph{Ergebnis}
					Die H\"ohe der Armeeauswahlbox wurde angepasst und entspricht den Vorgaben.
		...
		\subsection{Bugs}
			...
			\subsubsection{Ingame - Einheit mehrmals ausw\"ahlen}
				...
				\paragraph{Fix}
					Der Entwickler ben\"otigte eine Stunden um das Problem zu beheben. Die Hervorhebung wird nun immer korrekt gesetzt.
			...
			\subsubsection{Lobby - Spielbeitritt blockieren}
				...
				\paragraph{Fix}
					Die Behebung dieses Problems dauerte 30 Minuten. Es ist nicht mehr m\"oglich einem vollen Spiel beizutreten.
