        ...
        \subsection{Analyse}
        	...
        	\subsubsection{Abgeschlossene Stories} \label{done_stories_5}
    			...
    			\subsubsubsection{Ingame - Phase beenden}
    				...
    				\paragraph{Ergebnis}
    					Es gab nun einen Button, mit dem der Nutzer die Phase beenden konnte. Die dementsprechende Nachricht wurde an den Server geschickt. Auﬂerdem wurde der Button immer disabled, wenn der Nutzer nicht an der Reihe war oder wenn der Nutzer noch keine Bewegung in der ersten Phase machte.
        	...
        	\subsubsection{Angefangene Stories}
        		...
        		\subsubsubsection{Ingame - Einheit ausw"ahlen}
        			...
        			\paragraph{Stand}
        				Beim Ausw"ahlen einer Einheit durch Klicken auf ihre Graphik, wurde am Ende des f"unften Sprintes in den beiden Bewegungsphasen die Bewegungsreichweite blau angezeigt. In der Angriffsphase wurden alle Felder um die Einheit rot markiert. Es wurden weitere User Stories erstellt, um in der ersten Bewegungsphase auch die m"oglichen Angriffsziele anzuzueigen und um in der Angriffsphase nur die m"oglichen Angriffsziele anzuzeigen. Weiterhin wurde eine weitere Story erstellt, um in einer Bewegungsphase eine verk"urzte Bewegungsreichweite anzuzeigen, falls nach einer Bewegung noch Bewegungspunkte "ubrig waren.
        		\subsubsubsection{Ingame - Einheit bewegen}
        			\paragraph{Verlauf}
        				Diese Story lag f"ur den f"unften Sprint gut in der Zeit. Von den 13 gesch"atzten Stunden, wurden vom Entwickler zur Zeit nur 35 Minuten als verbleibende Zeit eingetragen, obwohl sogar nur 11 Stunden und 19 Minuten gearbeitet wurde. An sich gab es keine Probleme und die Story m"usste im n"achsten Sprint nur noch finalisiert werden.
        			\paragraph{Stand}
        				Die User Story war soweit mit all ihre Funktionalit"aten fertig. Die k"urzesten Pfade wurden berechnet und die Einheiten konnten auf das neue Feld bewegt werden. Der Entwickler wollte im n"achsten Sprint nur noch den Quellcode kontrollieren, Tests schreiben und beheben und Merge Konflikte l"osen, falls sich welche ergeben sollten.
        		\subsubsubsection{Ingame - Minikarte anzeigen}
        			\paragraph{Verlauf}
        				Obwohl die Story noch nicht abgeschlossen war, wurde die Zeitsch"atzung diesen Sprint bereits "uberschritten. Es wurden nur acht Stunden gesch"atzt, obwohl schon 25 Minuten mehr gearbeitet wurde. Die Funktionalit"at war allerdings bereits gegeben. Die Story wurde nur noch nicht beendet, da sich ihre zweite Subtask am Ende des Sprints, genauso wie die MockUps ‰nderte (Weitere Informationen folgen dazu noch im Kapitel \ref{changed_user_story_minimap}).
        			\paragraph{Stand}
   	...
   	\newpage
    	...
    	\subsection{Analyse}
    		...
    		\subsubsection{Behobene Bugs}
    			Es gab immer einmal wieder Bugs im Release \RN{3}. Diese konnten alle behoben werden (siehe Abbildung \ref{Fixed_Bugs_6}). Die Ursachen, die zu diesen Bugs f"uhrten (die der Entwickler fand), und und Fixes dieser 6 TODO Bugs werden im kommenden Kapitel genauer beschrieben werden. TODO: "Andern?
    			\begin{figure}[H]
    				\centering
